...
ZS_SPEC_TEST(variable_declaration,
  ZTITLE("Empty variable declaration"),
  ZDESCRIPTION("`a` is `null`."),
  ZCODE_A("var a;"))
{
...
//
ZS_SPEC_TEST(variable_declaration,
  ZTITLE("Empty variable declaration (without *;*)"),
  "`a` is `null`.",
  ZCODE_A("var a"))
{
  REQUIRE(value.is_null());
...
//
ZS_SPEC_TEST(variable_declaration,
  ZTITLE("Null variable declaration"),
  "`a` is `null`.",
  ZCODE_A("var a = null;"))
{
  REQUIRE(value.is_null());
...
//
ZS_SPEC_TEST(variable_declaration,
  ZTITLE("Integer variable declaration"),
  "",
  ZCODE_A("var a = 56;"))
{
  REQUIRE(value == 56);
...
//
ZS_SPEC_TEST(variable_declaration,
  ZTITLE("Float variable declaration"),
  "",
  ZCODE_A("var a = 56.6;"))
{
  REQUIRE(value == 56.6);
...
//
ZS_SPEC_TEST(variable_declaration,
  ZTITLE("Boolean variable declaration"),
  "",
  ZCODE_A("var a = true;"))
{
  REQUIRE(value == true);
...
//
ZS_SPEC_TEST(variable_declaration,
  ZTITLE("Character variable declaration"),
  "",
  ZCODE_A("var a = 'A';"))
{
  REQUIRE(value == 'A');
...
//
ZS_SPEC_TEST(variable_declaration,
  ZTITLE("String variable declaration"),
  "",
  ZCODE_A("var a = \"abc\";"))
{
  REQUIRE(value == "abc");
...
//
ZS_SPEC_TEST(variable_declaration,
  ZTITLE("Multiline string variable declaration"),
  "",
  ZCODE_A("var a = \"\"\"abc\"\"\";"))
{
  REQUIRE(value == "abc");
...
//
ZS_SPEC_TEST(variable_declaration,
  ZTITLE("Array variable declaration"),
  "",
  ZCODE_A("var a = [];"))
{
...
//
ZS_SPEC_TEST(variable_declaration,
  ZTITLE("Table variable declaration"),
  "",
  ZCODE_A("var a = {};"))
{
...
//
ZS_SPEC_TEST(variable_declaration,
  ZTITLE("Multiple variable declaration on a single line"),
  "Mix decl.",
...
ZS_SPEC_TEST(
  variable_declaration, ZTITLE("define"), ZDESCRIPTION(""), ZCODE_A(R"""(
