...
ZS_CODE_TEST("struct.empty.01", R"""(
var a = struct();
return a;
)""") {
  //  zb::print((int)zs::object_type::k_array);
}

//
ZS_CODE_TEST("struct.01", R"""(
