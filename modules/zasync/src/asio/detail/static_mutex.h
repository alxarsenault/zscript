...
# include "asio/detail/null_static_mutex.h"
#elif defined(ASIO_WINDOWS)
# include "asio/detail/win_static_mutex.h"
#elif defined(ASIO_HAS_PTHREADS)
# include "asio/detail/posix_static_mutex.h"
#else
# include "asio/detail/std_static_mutex.h"
#endif
