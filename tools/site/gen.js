...
fs.cp("data", "../../docs", {recursive: true}, (err) => {/* callback */});
...
for (let i = 0; i < flat_site_array.length; i++) {
  ...
  console.log("../../docs/" + page.name + ".html");
  fs.writeFileSync("../../docs/" + page.name + ".html", result);
}
...

{
  ...
  fs.writeFileSync("../../docs/contact.html",
