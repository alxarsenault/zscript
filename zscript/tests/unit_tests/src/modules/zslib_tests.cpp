...
#define ZS_IMPORT_ZS_MODULE "var zs = import('''zs''');\n"
#define ZS_CODE_TEST_WITH_STREAM(name, code) ZS_CODE_TEST(name, ZS_IMPORT_ZS_MODULE code, zs_test_init_func)
...
ZS_CODE_TEST("zs.print_to_string.01", ZS_IMPORT_ZS_MODULE R"""(
return zs.print_to_string("John", 32);)""") {
  REQUIRE(value == "John 32");
}

ZS_CODE_TEST("zs.print_to_string.02", ZS_IMPORT_ZS_MODULE R"""(
return zs.print_to_string<"">("John", 32);)""") {
  REQUIRE(value == "John32");
}

ZS_CODE_TEST("zs.print_to_string.03", ZS_IMPORT_ZS_MODULE R"""(
return zs.print_to_string<"-", "PP">("John", 32);)""") {
  REQUIRE(value == "John-32PP");
}

ZS_CODE_TEST("zs.write_to_string.02", ZS_IMPORT_ZS_MODULE R"""(
return zs.write_to_string("John", 32);)""") {
  REQUIRE(value == "John32");
}

ZS_CODE_TEST("zs.write_to_string.03", ZS_IMPORT_ZS_MODULE R"""(
var a = "p";
...
ZS_CODE_TEST("zs.write_to_string.04", ZS_IMPORT_ZS_MODULE R"""(
var a = {l = "8", k = "OO"};
...
ZS_CODE_TEST("zs.write_to_string.05", ZS_IMPORT_ZS_MODULE R"""(
var a = {l = "8", k = "OO"};
return zs["write_to_string"]<a.l, a["k"]>("John", 32);
)""") {
  REQUIRE(value == "John832OO");
...
ZS_CODE_TEST("zs.write_to_string.06", ZS_IMPORT_ZS_MODULE R"""(
var a = {l = "8", k = "OO"};
