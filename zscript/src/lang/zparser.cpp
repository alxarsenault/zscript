...
zs::error_result parser::parse<p_decl_var>() {
  ...
  ast_node var_type(
      _engine, ast_var_type, zs::object((zs::int_t)k_none).with_flags(object_flags_t::type_info));
  ...
  case tok_int:
    ...
    var_type.as_node().value() = zs::object((zs::int_t)k_integer).with_flags(object_flags_t::type_info);
    type_str = "int";
  ...
  case tok_float:
    ...
    var_type.as_node().value() = zs::object((zs::int_t)k_float).with_flags(object_flags_t::type_info);
    type_str = "float";
  ...
  case tok_string:
    ...
    var_type.as_node().value() = zs::object((zs::int_t)k_long_string).with_flags(object_flags_t::type_info);
    type_str = "string";
    cpp_type_str = "zs::var";
  ...
  case tok_array:
    ...
    var_type.as_node().value() = zs::object((zs::int_t)k_array).with_flags(object_flags_t::type_info);
    type_str = "array";
    cpp_type_str = "zs::var";
  ...
  case tok_table:
    ...
    var_type.as_node().value() = zs::object((zs::int_t)k_table).with_flags(object_flags_t::type_info);
    type_str = "table";
    cpp_type_str = "zs::var";
  ...
  case tok_bool:
    ...
    var_type.as_node().value() = zs::object((zs::int_t)k_bool).with_flags(object_flags_t::type_info);
    type_str = "bool";
...
zs::error_result parser::parse<p_create_function>(
  ...
  while (is_not(tok_rbracket)) {
    ...
    if (is(tok_triple_dots)) {
      ...
      ast_node var_type(_engine, ast_var_type, object((int_t)k_none).with_flags(object_flags_t::type_info));
      //      var_type._value = (zs::int_t)k_none;
      //      var_type._value._flags = object_flags_t::type_info;
