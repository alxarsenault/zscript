...
/// @brief Capture user data content.
class capture {
public:
  ZS_OBJECT_CLASS_COMMON;

  static object create(zs::engine* eng, object* ptr) noexcept;

  ZS_CHECK static capture& as_capture(const object_base& obj) noexcept;
