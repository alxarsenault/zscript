...
public:
  ...
  ZS_CHECK int_t key_index(const object& name) const noexcept;
...
private:
  ...
  ~struct_instance_object() noexcept = default;
...
public:
  ...
  zs::error_result resolve_constructor(zs::vm_ref vm, zs::parameter_list params, zs::object& constructor);

private:
  struct_object(zs::engine* eng) noexcept;
  ~struct_object() noexcept = default;
