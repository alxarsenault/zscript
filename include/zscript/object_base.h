...
ZS_CXPR bool object_base::is_enum() const noexcept {
  return is_table() and (_flags & object_flags_t::f_enum_table) != 0;
}
...
ZS_CXPR bool object_base::is_type_info() const noexcept {
  return (_flags & object_flags_t::f_type_info) == object_flags_t::f_type_info;
}

ZS_CXPR bool object_base::is_meta_argument() const noexcept {
  return (_flags & object_flags_t::f_meta_argument) == object_flags_t::f_meta_argument;
}
