...
namespace zs {
#define __ZS_JSON_TOK_IMPL_LAST(name) zs::json_token_type::tok_##name
#define __ZS_JSON_TOK_IMPL(name) zs::json_token_type::tok_##name,
#define ZS_JSON_TOK(...) ZBASE_FOR_EACH_WITH_LAST(__ZS_JSON_TOK_IMPL, __ZS_JSON_TOK_IMPL_LAST, __VA_ARGS__)

enum class json_token_type : uint8_t {
#define ZS_DECL_TOKEN(name) tok_##name,
#include "json/zjson_token_def.h"
#undef ZS_DECL_TOKEN
};
