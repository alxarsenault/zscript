...
class preprocessor_lexer : public engine_holder {
  ZS_CLASS_COMMON;

public:
  using enum token_type;

  preprocessor_lexer(zs::engine* eng);
  preprocessor_lexer(zs::engine* eng, std::string_view code);
  ~preprocessor_lexer();
...
struct preprocessor_lexer_ref {
  using enum token_type;
  zs::preprocessor_lexer* _lexer = nullptr;
